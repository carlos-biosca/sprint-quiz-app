          ...
          return (
            ...
            >
              <div className="game__pieces">
                <div className={card.records.entertainment ? "game__piece game__piece--entertainment" : "game__piece"}>
                  <img src={video} alt="Entertainment" />
                </div>
                <div className={card.records.history ? "game__piece game__piece--history" : "game__piece"}>
                ...
                <div className={card.records.art ? "game__piece game__piece--art" : "game__piece"}>
